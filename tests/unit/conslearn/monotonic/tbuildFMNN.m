classdef tbuildFMNN < matlab.unittest.TestCase
    ...
    methods(Test)
        function verifyInputLayerIsCorrect(testCase, InputSizeSet)
            ...
            % Build monotonic network
            net = conslearn.monotonic.buildFMNN(InputSizeSet.Input, 10);
        ...
        function verifyNetworkLengthIsCorrect(testCase, FullyConnectedLayerSizesSet)
            ...
            % Build monotonic network
            numberOfChannels = 20;
            net = conslearn.monotonic.buildFMNN( ...
                numberOfChannels, ...
        ...
        function verifyResidualMonotonicLayerIsCorrect(testCase, MonotonicTrendSet)
        ...
        function verifyNetworkHasACorrectLipschitzUpperBound(testCase, PNormSet, ResidualScalingSet)
            ...
            net = conslearn.monotonic.buildFMNN(10, [10, 50, 1000, 10], ...
